...
import 'package:emergencyfeedback/Screens/Login/components/background.dart';
import 'package:emergencyfeedback/Screens/Signup/signup_screen.dart';
          ...
          children: <Widget>[
            ...
            RoundedButton(
              ...
              press: () async {
                ...
                bool b = await loginWithEmailAndPassword(email, password);
                if (b == true) {
